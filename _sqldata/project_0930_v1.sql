...
INSERT INTO `member` (`memberId`, `memberName`, `memberBirthday`, `memberGender`, `memberTel`, `memberPhone`, `memberAddress`, `memberEmail`, `memberSnackTestResult`) VALUES
('100929490', '杜柔珊', '1993-07-25', 'F', '03763723', '0953797894', '苗栗縣頭份市中正二路104號', 'xozubami55235@gmail.com', 4),
('100933628', '王宥平', '1998-12-18', 'M', '042536515', '0970123233', '台中市北區北平路二段208號', 'john11nnn887@gmail.com', 2),
('100938467', '趙世昌', '1983-01-30', 'M', '025468650', '0912076954', '台北市士林區福華路17巷1號', '4changzhao@gmail.com', 4),
('100982031', '謝羿卉', '1987-12-05', 'F', '043979015', '0934169127', '台中市豐原區社興五街5巷20號', 'nami1205@hotmail.com', 3);
...
('Salysol罐頭軟糖60g', 59, '西班牙', 7, 100, 1, '甜', '1', '糖果', '3', 'Salysol已有40年的歷史，是西班牙專門製作零食的廠牌。而他們最具特色的就是封裝零食的迷你罐頭了! 使用真空無菌包裝的方式，輕巧特殊的罐頭造型十分吸睛，在西班牙已是家喻戶曉的品牌。綜合口味的軟糖柳橙、檸檬、草莓三種口味製成5款造型，其中還有超特別的顆粒軟糖，外形像迷你葡萄串，吃起來外脆內Q；草莓口味的軟糖由高品質的白砂糖製作，只有手心般的大小，非常好攜帶，無論是外出郊遊或是工作肚子餓，大人小孩都能一同享用！', '/images/product_img/prodImg_1_1.png', '/images/product_img/prodImg_1_2.jpg', NULL),
...
CREATE TABLE `suborder` (
  ...
  `subName` varchar(10) COLLATE utf8mb4_bin NOT NULL,
  `subPhone` char(10) COLLATE utf8mb4_bin NOT NULL,
  `subPlan` char(3) COLLATE utf8mb4_bin NOT NULL,
  `subPrice` int(11) NOT NULL,
  `subPayment` varchar(10) COLLATE utf8mb4_bin NOT NULL,
  `subDeli` varchar(10) COLLATE utf8mb4_bin NOT NULL,
  `subState` varchar(5) COLLATE utf8mb4_bin NOT NULL,
  `subSendState` varchar(5) COLLATE utf8mb4_bin NOT NULL,
  `subMemo` varchar(200) COLLATE utf8mb4_bin DEFAULT NULL,
  `memberId` varchar(50) COLLATE utf8mb4_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `suborder` (`subNo`, `subDate`, `subName`, `subPhone`, `subPlan`, `subPrice`, `subPayment`, `subDeli`, `subState`, `subSendState`, `subMemo`, `memberId`) VALUES
(210010001, '2021-08-10', '杜柔珊', '0953797894', '超值箱', 499, '信用卡', '宅配', '已取消', '無', NULL, '100929490'),
(210030001, '2021-07-30', '趙世昌', '0912076954', '派對箱', 999, '信用卡', '全家取貨', '訂閱中', '已送達', NULL, '100938467'),
(210030002, '2021-08-30', '趙世昌', '0912076954', '派對箱', 999, '信用卡', '全家取貨', '訂閱中', '已送達', NULL, '100938467');
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `collectedProd`
--
ALTER TABLE `collectedProd`
...
--
ALTER TABLE `satisfaction`
  ADD CONSTRAINT `satisfaction_ibfk_1` FOREIGN KEY (`subNo`) REFERENCES `suborder` (`subNo`);
COMMIT;
